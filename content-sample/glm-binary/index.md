...
<br>
[Linear models](%base_url%/?linear-models-introduction)
(e.g., linear regression) are used to model the relationship between a **continuous** response variable ![](https://latex.codecogs.com/svg.latex?y) and one or more explanatory variables ![](https://latex.codecogs.com/svg.latex?x_1,x_2,\cdots). When we have a **discrete** response we use generalised linear models (GLM's).

![](%theme_url%/img/GLM1_binary_image.jpg)
